...
class Constants:
    def __init__(self) -> None:
        # Patcher Versioning
        self.patcher_version:                 str = "2.1.3"  # OpenCore-Legacy-Patcher
        ...
        self.lilu_version:               str = "1.6.9"  #      Lilu
        self.whatevergreen_version:      str = "1.6.8"  #      WhateverGreen
        self.whatevergreen_navi_version: str = "1.6.8-Navi"  # WhateverGreen (Navi Patch)
